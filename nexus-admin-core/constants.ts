...
export const MOCK_USERS: MobileUser[] = [
  {
    ...
    lastActive: "2023-10-27T10:30:00",
    platform: "Android",
    status: "online",
    totalSpent: 1500,
    lastIp: "182.23.11.5",
  },
  {
    ...
    lastActive: "2023-10-27T09:15:00",
    platform: "iOS",
    status: "offline",
    totalSpent: 3400,
    lastIp: "49.229.14.2",
  },
  {
    ...
    email: "peter@spidey.net",
    lastActive: "2023-10-26T22:00:00",
    platform: "iOS",
    status: "online",
    totalSpent: 500,
    lastIp: "27.55.12.9",
  },
  {
    ...
    lastActive: "2023-10-27T11:00:00",
    platform: "Android",
    status: "banned",
    totalSpent: 99999,
    lastIp: "1.2.3.4",
  },
  {
    ...
    lastActive: "2023-10-27T08:45:00",
    platform: "iOS",
    status: "online",
    totalSpent: 2100,
    lastIp: "180.12.44.1",
  },
  {
    ...
    lastActive: "2023-10-25T14:20:00",
    platform: "Android",
    status: "offline",
    totalSpent: 1200,
    lastIp: "110.168.1.5",
  },
  {
    ...
    lastActive: "2023-10-27T10:05:00",
    platform: "Android",
    status: "frozen",
    totalSpent: 800,
    lastIp: "58.9.11.2",
...
export const MOCK_LOGS: SystemLog[] = [
  {
    ...
    timestamp: "10:30:05",
    level: "INFO",
    message: "User U001 logged in successfully",
    source: "AUTH",
    ip: "182.23.11.5",
  },
  {
  ...
  },
  {
    ...
    timestamp: "10:15:00",
    level: "ERROR",
    message: "Payment gateway timeout for transaction #9921",
    source: "API",
  },
  {
    id: "L004",
  ...
  },
  {
    ...
    timestamp: "09:55:10",
    level: "CRITICAL",
    message: "Multiple failed login attempts detected (Brute Force)",
    source: "SECURITY",
    ip: "185.11.22.33",
  },
  {
...
export const MOCK_NOTIFICATIONS: PushNotification[] = [
  {
    id: "N001",
    title: "Flash Sale! ⚡️",
    message: "ลดราคา 50% ทุกรายการ เฉพาะวันนี้เท่านั้น",
    target: "All",
    sentAt: "2023-10-27 09:00",
    status: "Sent",
    openRate: 24.5,
  },
  {
    ...
    message: "กรุณาอัปเดตแอปเป็นเวอร์ชันล่าสุด",
    target: "Mobile",
    sentAt: "2023-10-26 14:00",
    status: "Sent",
    openRate: 15.2,
  },
  {
    ...
    message: "รับคูปองส่วนลด 100 บาท",
    target: "Landing",
    sentAt: "2023-10-28 10:00",
    status: "Scheduled",
    openRate: 0,
  },
];
...
export const MOCK_BANNERS: AppBanner[] = [
  {
    ...
    actionUrl: "app://promotion/summer",
    isActive: true,
    order: 1,
...
export const MOCK_CLUSTER_NODES: ClusterNode[] = Array.from({ length: 12 }).map(
  (_, i) => ({
...
export const MOCK_CIRCUIT_BREAKERS: CircuitBreaker[] = [
  ...
  {
    service: "Map/Location API",
    state: "HALF-OPEN",
    failureRate: 15.5,
    lastTripTime: "10:02:00",
  },
  {
    service: "SMS Provider",
    state: "CLOSED",
    failureRate: 0.5,
    lastTripTime: "08:30:00",
  },
  {
    service: "Image Processing",
    state: "OPEN",
    failureRate: 100,
    lastTripTime: "10:05:00",
  },
];
...
export const MOCK_BLOCKED_IPS: IpBlockEntry[] = [
  ...
  },
  {
    id: "BLK-002",
    ip: "45.155.205.10",
    reason: "High rate limit violation (DDoS)",
    blockedAt: "2023-10-27 09:45",
    expiresAt: "2023-10-28 09:45",
    blockedBy: "System WAF",
    status: "Active",
  },
  {
    id: "BLK-003",
    ip: "103.22.14.5",
    reason: "Bot spamming registration",
    blockedAt: "2023-10-26 15:00",
    expiresAt: "2023-11-26 15:00",
    blockedBy: "AdminMaster",
    status: "Active",
  },
];
...
export const MOCK_SECURITY_RULES: SecurityRule[] = [
  ...
  {
    id: "RULE-003",
    name: "Bot Protection (Aggressive)",
    type: "Bot-Protection",
    target: "Global",
    action: "CHALLENGE",
    isEnabled: false,
...
export const MOCK_TICKETS: SupportTicket[] = [
  ...
  },
  {
    id: "TCK-5513",
    userId: "U002",
    subject: "ขอเปลี่ยนเบอร์โทรศัพท์",
    status: "IN_PROGRESS",
    priority: "MEDIUM",
    lastUpdated: "10:15 AM",
    category: "Account",
    assignedTo: "AdminSafe",
  },
  {
    id: "TCK-5514",
    userId: "U005",
    subject: "แอปค้างหน้าโหลด",
    status: "OPEN",
    priority: "HIGH",
...
export const MOCK_CHAT_HISTORY: ChatMessage[] = [
  {
    id: "MSG-1",
    sender: "USER",
    message: "สวัสดีครับ ผมโอนเงินไป 500 บาทเมื่อกี้ แต่ยอดในแอปไม่ขึ้นครับ",
    timestamp: "10:28 AM",
  },
  {
    id: "MSG-2",
    sender: "BOT",
    message:
      "สวัสดีครับ ระบบได้รับข้อความของคุณแล้ว เจ้าหน้าที่กำลังตรวจสอบให้นะครับ (Ticket #TCK-5512)",
    timestamp: "10:28 AM",
  },
];
...
export const MOCK_AUTO_REPLY_RULES: AutoReplyRule[] = [
  {
    ...
    keyword: "โอนเงิน",
    response:
      "หากพบปัญหาโอนเงิน กรุณาส่งสลิปโอนเงินมาในแชทนี้ เพื่อให้ระบบตรวจสอบยอดเงินอัตโนมัติครับ",
    isEnabled: true,
  },
  {
    id: "AR-02",
    keyword: "รหัสผ่าน",
    response:
      'คุณสามารถรีเซ็ตรหัสผ่านได้ที่เมนู "ลืมรหัสผ่าน" ในหน้า Login ครับ',
    isEnabled: true,
  },
  {
    id: "AR-03",
    keyword: "ลบข้อมูล",
    response:
      "การลบข้อมูลบัญชีต้องดำเนินการผ่าน Email support@aqond.com เพื่อยืนยันตัวตนครับ",
    isEnabled: false,
  },
];
...
export const MOCK_DOCS: DocArticle[] = [
  {
    id: "DOC-001",
    title: "วิธีใช้งาน Security Center และการบล็อก IP",
    category: "Security",
    lastUpdated: "2023-10-27",
    content: "Security Center Guide...",
  },
  {
    id: "DOC-002",
    title: "การกู้คืนระบบเมื่อเกิดภัยพิบัติ (Disaster Recovery)",
...
export const MOCK_PAYOUTS: PayoutRequest[] = [
  {
    ...
    amount: 5200,
    bankName: "KBANK",
    accountNumber: "084-2-xxxxx-5",
    riskScore: 5,
    status: "PENDING",
    requestedAt: "2023-10-27 10:00",
    kycStatus: "VERIFIED",
  },
  {
    id: "PO-5522",
    ...
    amount: 150000,
    bankName: "SCB",
    accountNumber: "112-2-xxxxx-9",
    riskScore: 88,
    status: "PENDING",
    requestedAt: "2023-10-27 09:30",
    kycStatus: "VERIFIED",
  },
  {
    id: "PO-5523",
    ...
    amount: 450,
    bankName: "BBL",
    accountNumber: "552-0-xxxxx-1",
    riskScore: 2,
    status: "APPROVED",
    requestedAt: "2023-10-26 15:45",
    kycStatus: "VERIFIED",
  },
];
  ...
  allocation: [
    {
      ...
      percentage: 30,
      amount: 4500000,
      description: "New features and AI development",
    },
    {
      category: "Marketing",
      percentage: 25,
      amount: 3750000,
      description: "User acquisition ads",
    },
    {
      category: "Operations",
      percentage: 20,
      amount: 3000000,
      description: "Server costs and staff",
    },
    {
      category: "Legal & Compliance",
      percentage: 10,
      amount: 1500000,
      description: "Licenses and audit fees",
    },
    {
