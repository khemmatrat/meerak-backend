...
const SupportChat = () => {
    ...
    const quickReplies = ["เงินไม่เข้า", "งานหายไปไหน?", "KYC ไม่ผ่าน", "ถอนเงินยังไง"];
            ...
            <div className="flex flex-wrap gap-2 mb-3">
                {quickReplies.map(q => (
                    <button 
                        ...
                        className="text-xs bg-emerald-50 text-emerald-700 border border-emerald-100 px-3 py-1 rounded-full hover:bg-emerald-100 transition-colors"
                    >
                        {q}
                    </button>
                ))}
