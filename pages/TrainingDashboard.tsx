        ...
        if (user?.id) {
          ...
          if (user?.role === UserRole.PROVIDER) {
            try {
              ...
              setExamResults(results.map((r: any) => ({ module: r.module, passed: r.passed })));
            } catch (_) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Provider Onboarding: ต้องผ่านแบบทดสอบก่อนรับงาน */}
        {providerStatus === 'PENDING_TEST' && (
          <div className="mb-8 p-6 bg-amber-50 border-2 border-amber-400 rounded-xl flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-amber-900">แบบทดสอบบังคับสำหรับ Provider</h3>
            ...
            <button
              onClick={() => { setTab('courses'); navigate('/training/course/nexus-professional-standards'); }}
