...
export const Welcome: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-emerald-600 relative flex flex-col overflow-y-auto">
      <GrandOpeningOverlay />
      {/* Language Switcher */}
      <div className="absolute top-4 right-4 z-10 flex items-center bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full border border-white/20">
        ...
        >
          ...
          <option value="th" className="text-gray-800">
            ไทย
          </option>
      ...
      {/* Hero Image — min-height แทน flex-1 เพื่อไม่ให้ถูกบีบเมื่อแบนเนอร์ 9:16 สูง */}
      <div className="relative min-h-[38svh] max-h-[46svh] shrink-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 pb-12">
          ...
          <h2 className="text-xl text-emerald-200 font-medium mb-4">
            {t("welcome_screen.subtitle")}
          </h2>
      ...
      {/* Actions — shrink-0 ให้ปุ่ม + แบนเนอร์ไม่ถูกพับ */}
      <div className="bg-white rounded-t-3xl p-8 -mt-6 relative z-10 isolate shrink-0 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] pb-[max(2rem,env(safe-area-inset-bottom))]">
        ...
        <div className="mt-6 text-center flex flex-col items-center gap-2">
          ...
          <span className="flex items-center text-[10px] text-slate-400">
            <Shield size={10} className="mr-1" /> Admin: nexus-admin-core
            (แอปแยก)
          </span>
        </div>
      </div>
