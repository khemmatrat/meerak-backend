...
export function MobileTabNav() {
  ...
  if (path.startsWith('/m/rider') || path.startsWith('/storefront/rider-os') || path.startsWith('/m/services') || path.startsWith('/m/live') || path.startsWith('/m/product') || path.startsWith('/m/shop') || path.startsWith('/m/checkout') || path.startsWith('/m/chat')) return null;
