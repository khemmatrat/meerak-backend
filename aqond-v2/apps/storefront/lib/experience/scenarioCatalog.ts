...
export const SCENARIO_BUSINESS_CATALOG: Record<string, ScenarioBusinessMeta> = {
  ...
  'B2.5-S001': {
    ...
    mission_id: 'DELIVERY-CORE',
    surface: 'delivery_core_config',
    title: 'Delivery Core — configuration load',
    business_impact: 'high',
  ...
  'B2.5-S002': {
    ...
    title: 'Delivery Core — province configuration',
    business_impact: 'high',
  ...
  'B2.6-S001': {
    ...
    mission_id: 'RECEIPT-CORE',
    surface: 'receipt_engine',
    title: 'Receipt Core — engine foundation',
    business_impact: 'high',
    time_saved_minutes: 18,
    module: 'receipt-core',
  },
  'B2.6-S002': {
    scenario_id: 'B2.6-S002',
    mission_id: 'RECEIPT-CORE',
    surface: 'marketplace_receipt',
    title: 'Receipt Core — marketplace production wiring (R001)',
    business_impact: 'critical',
    time_saved_minutes: 22,
    module: 'receipt-core',
  },
  'B2.6-S003': {
    scenario_id: 'B2.6-S003',
    mission_id: 'RECEIPT-CORE',
    surface: 'receipt_verify_qr',
    title: 'Receipt Core — signed verify QR anti-forgery',
    business_impact: 'high',
    time_saved_minutes: 16,
    module: 'receipt-core',
  },
  'B2.6-S004': {
    scenario_id: 'B2.6-S004',
    mission_id: 'RECEIPT-CORE',
    surface: 'jarvis_audit',
    title: 'Receipt Core — Jarvis audit envelope on R001',
    business_impact: 'high',
    time_saved_minutes: 14,
    module: 'receipt-core',
  },
  'B2.7-S001': {
    ...
    mission_id: 'RETURN-REFUND-CORE',
    surface: 'return_request',
    title: 'Return Core — OR001 return request',
    business_impact: 'critical',
    time_saved_minutes: 20,
    module: 'return-core',
  },
  'B2.7-S002': {
    scenario_id: 'B2.7-S002',
    mission_id: 'RETURN-REFUND-CORE',
    surface: 'refund_detail',
    title: 'Return Core — OR002 refund detail',
    business_impact: 'high',
    time_saved_minutes: 16,
    module: 'return-core',
  },
  'B2.7-S003': {
    scenario_id: 'B2.7-S003',
    mission_id: 'RETURN-REFUND-CORE',
    surface: 'escrow_adapter',
    title: 'Return Core — OR004 escrow adapter',
    business_impact: 'critical',
    time_saved_minutes: 18,
    module: 'return-core',
  },
