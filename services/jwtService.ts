...
const TOKEN_CONFIG = {
  ...
  secret: process.env.JWT_SECRET || 'meerak-secret-key-change-in-production',
  refresh_secret: process.env.JWT_REFRESH_SECRET || 'meerak-refresh-secret-change-in-production'
};
