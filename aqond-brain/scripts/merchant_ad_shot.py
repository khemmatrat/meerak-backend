#!/usr/bin/env python3
"""AIVOS merchant-ad Sprint 4 — single shot clip via Grok image-to-video."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Merchant ad shot clip (Grok i2v)")
    ...
    log = logging.getLogger("merchant_ad_shot")
    ...
    dur = max(1, min(5, int(round(args.duration))))
